...
function UserProfile(props) {
  ...
  const onSubmit = async (e) => {
    ...
    if (!userProfile.placeOfbirth && !userProfile.timeOfbirth && !userProfile.dob === false) {
              ...
              <div className="my-4">
                ...
                >
                  <Form.Control
                    ...
                    onChange={handleChange}
                  />
                  {errors.timeOfbirth && <p className="errormsg">{errors.timeOfbirth}</p>}
                ...
                >
                  <Form.Control
                    ...
                    onChange={handleChange}
                  />
                  {errors.placeOfbirth && <p className="errormsg">{errors.placeOfbirth}</p>}
